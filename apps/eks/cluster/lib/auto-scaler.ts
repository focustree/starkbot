import { Stack, CfnJson, Tags } from 'aws-cdk-lib';
...
export class AutoScaler {
    ...
    static enableAutoscaling(stack: Stack, cluster: eks.Cluster, ng: eks.Nodegroup, imageVersion: string = "v1.20.3") {
              ...
              spec: {
                ...
                template: {
                  ...
                  spec: {
                    ...
                    containers: [
                      {
                        image: "k8s.gcr.io/autoscaling/cluster-autoscaler:" + imageVersion,
                        name: "cluster-autoscaler",
                        resources: {
                          limits: {
                            cpu: "100m",
